...
public class LocationUpdatesService extends Service {
    ...
    public void onCreate() {
        ...
        desLoc = SetAlarmActivity.loc;
        Log.i("hifromother",desLoc.toString());
    ...
    private void getLastLocation() {
        ...
        String s = mFusedLocationClient.getLastLocation().toString();
        Log.w("log", s);
        try {
    ...
    private void onNewLocation(Location location) {
        ...
        if(desLoc.distanceTo(location)<100){
           ///alarmmanager
            ...
            i2 = new Intent(this, AlarmReceiver.class);
            //AlarmReceiver.class
